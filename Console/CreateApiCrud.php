...
class CreateApiCrud extends Command
{
    ...
    public function updateController($name)
    {
        ...
        if ($this->option('action')) {
            ...
            $storeAction = str_replace('public function handle($handle)', 'public function handle(Array $request): ' . $this->model, $storeAction);
            ...
            $updateAction = str_replace('public function handle($handle)', 'public function handle(' . $this->model . ' $' . $this->varModel . ', Array $request): ' . $this->model, $updateAction);
            ...
            $deleteAction = str_replace('public function handle($handle)', 'public function handle(' . $this->model . ' $' . $this->varModel . '): ?bool', $deleteAction);
            $deleteAction = str_replace('// ..', '$handle = $' . $this->varModel . '->delete();', $deleteAction);
